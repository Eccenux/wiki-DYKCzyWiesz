...
(function() {
	...
	5: [ function(require, module, exports) {
		...
		`);
				...
				Hasła muszą posiadać źródła w formie przypisów oraz muszą zawierać co najmniej <xkb>2</xkb> kB samej treści.</small>`).css({
					border: '1px solid var(--background-color-option-yellow)',
					backgroundColor: 'var(--background-color-warning-subtle)',
					paddingLeft: '5px'
				});
