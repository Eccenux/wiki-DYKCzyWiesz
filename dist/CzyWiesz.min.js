	...
	5: [ function(require, module, exports) {
		...
		`);
			...
			`);
				...
				var $images_row = $('<tr class="u-img-row"></tr>').html('<td class="u-lbl">Liczba grafik w artykule: </td>' + '<td class="u-data"><input type="number" min="0" id="CzyWieszImages" name="CzyWieszImages" value="' + IMG_ARR.length + '">' + '<span id="CzyWieszGalleryToggler" style="display: none;"><a href="#" role="button">(zaproponuj grafikę z artykułu)</a></span>');
				var $file_row = $('<tr class="u-file-row"></tr>').html('<td class="u-lbl"><input type="checkbox" id="CzyWieszFile1" name="CzyWieszFile1"><label for="CzyWieszFile1"> Zaproponuj grafikę: </label></td>' + '<td class="u-data"><code>[[Plik:</code><input type="text" id="CzyWieszFile2" name="CzyWieszFile2" disabled><code>|100px|right]]</code></td>');
				var $author_row = $(`
		...
		`);
				...
				const $main_table = $('<table class="dyk-form-tbl"></table>').append($ref_row).append($images_row).append($file_row).append($author_row).append($wikiproject_row).append($events_row);
