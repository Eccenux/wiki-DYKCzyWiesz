		...
		`.replace(/\n\t+/g, '').trim());
				...
				if (IMAGES > 0) {
					...
					$('#CzyWieszGalleryToggler a').click(function() {
						var GALLERY = '<div id="CzyWieszGalleryHolder">' + '<div id="CzyWieszGallery" style="background-color: #F2F5F7;">' + '<table><tbody>';
			...
			async pagerevs() {
				...
				const {
					revisions,
					records
				} = await this.revisionList.readRevs(D.wgTitle, 10);
