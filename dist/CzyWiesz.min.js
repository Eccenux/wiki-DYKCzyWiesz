...
(function() {
	...
	5: [ function(require, module, exports) {
		...
		`));
				...
				var $title_paragraph = $('<p></p>').html('Tytuł artykułu: &nbsp;&nbsp;<input type="text" id="CzyWieszTitle" name="CzyWieszTitle" value="' + D.wgTitle + '" disabled>');
		...
		`);
				...
				var $comment_textarea_paragraph = $('<p id="CzyWieszCommentContainer" style="display: none;"></p>').html('<textarea id="CzyWieszComment" rows="2" value=""></textarea>');
				...
				const $main_table = $('<table class="dyk-form-tbl"></table>').append($ref_row).append($images_row).append($file_row).append($author_row).append($signature_row).append($wikiproject_row).append($events_row);
