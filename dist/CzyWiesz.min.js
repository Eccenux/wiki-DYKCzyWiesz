	...
	5: [ function(require, module, exports) {
		...
		`);
			...
			`);
				...
				var $images_row = $('<tr></tr>').html('<td>Liczba grafik w artykule: </td>' + '<td><input type="number" min="0" id="CzyWieszImages" name="CzyWieszImages" value="' + IMG_ARR.length + '"' + 'style="width: 3.5em;">' + '<span id="CzyWieszGalleryToggler" style="display: none;"> &nbsp;<small><a href="#" role="button">(zaproponuj grafikę z artykułu)</a></small></span>');
				...
				this.appendActions(sddGal, {
					"Zatwierdź": function() {
						...
						if (choosen.length > 0) {
							...
							$('#CzyWieszFile1').prop('checked', false);
							$('#CzyWieszFile2').val('');
						}
						sddGal.hide();
					},
