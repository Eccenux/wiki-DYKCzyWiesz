...
window.DYKnomination = {
	about : {
		version    : '5.5.5'+(window.DYKnomination_is_beta===true?'beta':''),
	...
	DYKnomination.wikiprojects = {
		...
		load : function () {
			...
			.done(function(data){
			        ...
			        D.wikiprojects.list_wikiprojects_active.sort(Intl.Collator().compare);
...
*/
	...
	DYKnomination.askuser = function () {
		...
		var $file_row = $('<tr></tr>')
			.html('<td style="width: 30%;"><input type="checkbox" id="CzyWieszFile1" name="CzyWieszFile1" style="vertical-align: middle;"> Zaproponuj grafikę: </td>' // style="width: 36%;
		...
		var $author_row = $('<tr></tr>')
			.html('<td>Główny autor artykułu<a href="#" title="Gadżet wstawia autora największej edycji w ciągu ostatnich 10 dni (upewnij się!)"><sup>?</sup></a>: </td>'
				...
				+ '&nbsp;&nbsp;<input type="checkbox" id="CzyWieszAuthorInf" name="CzyWieszAuthorInf" style="vertical-align: middle;">poinformować go?</td>');
